...
char msg[128];
char base[256]={"/media/CAM/datalogger/generico"};
char file_configura[256]={"/home/pi/generico/configura.txt"};
FILE *fc;
FILE *fp;
...
//		result1 = READ_AD_DATA(DATA_REGISTER|_READ|CHANNEL1);
	...
	bcm2835_gpio_clr(LED);			//FINALIZA LA MEDIDA
